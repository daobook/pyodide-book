...
process. We鈥檒l detail how you can start making PRs below.

We鈥檒l do our best to keep `main` in a non-breaking state, ideally with tests
...
If you鈥檙e looking for a way to jump in and contribute, our list of
[good first issues](https://github.com/pyodide/pyodide/labels/good%20first%20issue)
is a great place to start.

If you鈥檇 like to fix a currently-filed issue, please take a look at the comment
thread on the issue to ensure no one is already working on it. If no one has
claimed the issue, make a comment stating you鈥檇 like to tackle it in a PR. If
someone has claimed the issue but has not worked on it in a few weeks, make a
comment asking if you can take over, and we鈥檒l figure it out from there.
...
Github if your PR doesn鈥檛 pass all of them. If your PR fails a test, try to
...
everyone to assess. Take a moment and look through how we鈥檝e written our tests,
...
### Contributing to the 鈥渃ore鈥� C Code
